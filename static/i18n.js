...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    skills_ontosynth_platform_catalog: 'Platform Catalog',
    skills_ontosynth_project_contract: 'Project Contract',
    skills_ontosynth_runtime_materialized: 'Runtime Materialized',
    skills_ontosynth_platform_catalog_summary: 'Project: {0} · Skills: {1}',
    skills_ontosynth_role_count: 'Roles: {0}',
    skills_ontosynth_profile_count: 'Profiles: {0}',
    skills_ontosynth_contract_summary: 'Preloaded: {0} · Managed: {1} · Bundled: {2}',
    skills_ontosynth_runtime_summary: 'Materialized: {0} · Verified local/builtin: {1}/{2}',
    skills_ontosynth_preloaded_keys: 'Preloaded keys',
    skills_ontosynth_managed_contract_keys: 'Managed contract keys',
    skills_ontosynth_allowed_bundled_skills: 'Allowed bundled skills',
    skills_ontosynth_materialized_visible_skills: 'Materialized visible skills',
    skills_ontosynth_contract_only_referenced_skills: 'Contract-only referenced skills',
    skills_ontosynth_no_platform_match: 'No platform skills matched.',
    skills_ontosynth_no_contract_match: 'No contract roles matched.',
    skills_ontosynth_no_runtime_match: 'No runtime profiles matched.',
    skills_ontosynth_managed_skill_drilldown: 'Managed skill details',
    skills_ontosynth_runtime_skill_drilldown: 'Runtime skill details',
    skills_ontosynth_skill_references: 'Skill references',
    skills_ontosynth_when_to_load: 'When to load',
    skills_ontosynth_workflow: 'Workflow',
    skills_ontosynth_deliverables: 'Deliverables',
    skills_ontosynth_success_metrics: 'Success metrics',
    skills_ontosynth_runtime_status: 'Runtime status',
    skills_ontosynth_contract_backlink: 'Contract backlink',
    skills_ontosynth_contract_backlink_reference: 'Open managed contract reference',
    skills_ontosynth_contract_backlink_preloaded: 'Covered by session-preloaded contract only.',
    skills_ontosynth_preloaded_runtime_reference: 'Preloaded runtime skill reference',
    skills_ontosynth_materialized_runtime_reference: 'Materialized runtime skill reference',
    skills_ontosynth_reference_content: 'Reference content',
    skills_ontosynth_reference_expand: 'Show',
    skills_ontosynth_reference_collapse: 'Hide',
    skills_ontosynth_local_verification: 'Local verification',
    skills_ontosynth_builtin_verification: 'Builtin verification',
    skills_ontosynth_no_managed_skill_detail: 'No managed skill details available.',
    skills_ontosynth_no_runtime_skill_detail: 'No runtime skill details available.',
    skills_ontosynth_no_contract_backlink: 'No contract-backed detail available.',
    skills_ontosynth_no_reference_content: 'No reference content available.',
    // workspace form
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    skills_ontosynth_platform_catalog: '平台技能目录',
    skills_ontosynth_project_contract: '项目技能契约',
    skills_ontosynth_runtime_materialized: '运行时已装载技能',
    skills_ontosynth_platform_catalog_summary: '项目：{0} · 技能：{1}',
    skills_ontosynth_role_count: '角色：{0}',
    skills_ontosynth_profile_count: '配置档：{0}',
    skills_ontosynth_contract_summary: '预加载：{0} · 托管：{1} · Bundled：{2}',
    skills_ontosynth_runtime_summary: '已装载：{0} · 已验证 local/builtin：{1}/{2}',
    skills_ontosynth_preloaded_keys: '预加载键',
    skills_ontosynth_managed_contract_keys: '托管契约键',
    skills_ontosynth_allowed_bundled_skills: '允许的 Bundled skills',
    skills_ontosynth_materialized_visible_skills: '当前可见的已装载技能',
    skills_ontosynth_contract_only_referenced_skills: '仅契约引用的技能',
    skills_ontosynth_no_platform_match: '没有匹配的平台技能。',
    skills_ontosynth_no_contract_match: '没有匹配的契约角色。',
    skills_ontosynth_no_runtime_match: '没有匹配的运行时配置档。',
    skills_ontosynth_managed_skill_drilldown: '托管技能详情',
    skills_ontosynth_runtime_skill_drilldown: '运行时技能详情',
    skills_ontosynth_skill_references: '技能参考内容',
    skills_ontosynth_when_to_load: '何时加载',
    skills_ontosynth_workflow: '工作流',
    skills_ontosynth_deliverables: '交付物',
    skills_ontosynth_success_metrics: '成功指标',
    skills_ontosynth_runtime_status: '运行时状态',
    skills_ontosynth_contract_backlink: '契约回链',
    skills_ontosynth_contract_backlink_reference: '打开托管契约参考',
    skills_ontosynth_contract_backlink_preloaded: '仅由 session preloaded contract 覆盖。',
    skills_ontosynth_preloaded_runtime_reference: '预加载运行时技能参考',
    skills_ontosynth_materialized_runtime_reference: '运行时已装载技能参考',
    skills_ontosynth_reference_content: '参考内容',
    skills_ontosynth_reference_expand: '展开',
    skills_ontosynth_reference_collapse: '收起',
    skills_ontosynth_local_verification: '本地校验',
    skills_ontosynth_builtin_verification: '内建校验',
    skills_ontosynth_no_managed_skill_detail: '没有可用的托管技能详情。',
    skills_ontosynth_no_runtime_skill_detail: '没有可用的运行时技能详情。',
    skills_ontosynth_no_contract_backlink: '没有可回链的契约详情。',
    skills_ontosynth_no_reference_content: '没有可用的参考内容。',
    cron_duplicate: '复制',
